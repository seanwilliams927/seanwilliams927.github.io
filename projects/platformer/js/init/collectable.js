(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 6, 1.1);
        collectable.create(type.kennedi, 450, 200, 8, 1.1);
        collectable.create(type.grace, 370, 350, 10, 1.1);
        collectable.create(type.kennedi,150, 265, 7, 1.1);
